...
// GET /api/npt — all pianos including inactive (admin only)
...
// PATCH /api/npt — update piano by id
...
// DELETE /api/npt?id=... — soft-delete (set is_active = false)

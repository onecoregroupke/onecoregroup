...
export default function BrandPage() {
  ...
  if (!brand) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/" className="text-ocg-navy text-sm mt-2 inline-block hover:underline">← Dashboard</Link>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <Link href="/" className="inline-flex items-center gap-2 text-gray-500 text-sm hover:text-ocg-navy transition-colors">
      ...
      {metrics.length > 0 ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 text-center">
          ...
          <Link href="/input" className="text-ocg-navy font-medium text-sm mt-2 inline-block hover:underline">

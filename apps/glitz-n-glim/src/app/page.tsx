              ...
              {cat.products.map(p => (
                ...
                >
                  ...
                  <div className="relative w-full aspect-[3/4] sm:aspect-[2/3] bg-gray-50">
                    ...
                    {p.variant && (
                      <span className="absolute top-2 right-2 text-[10px] font-bold px-2 py-0.5 rounded-full bg-white/90 text-gray-800 shadow">
                        {p.variant}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="p-3.5 flex flex-col flex-1 gap-2.5">
                    ...
                    <div className="mt-auto flex items-center justify-between pt-2.5 border-t border-gray-100">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 bg-[#25d366] text-white text-xs font-bold px-3 py-2 rounded-full hover:bg-[#1da851] transition-colors shadow-sm"
                      >

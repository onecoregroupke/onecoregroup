...
export default async function RayyanStudentsPage() {
  ...
  return (
    <List title="Rayyan students" description="Student records, class level, enrollment state, and admission references.">
      <RayyanActionPanel

...
export default async function RayyanFeeFollowupsPage() {
  ...
  return (
    <div className="space-y-5">
      <div><h1 className="text-2xl font-semibold text-gray-900">Fee follow-ups</h1><p className="text-sm text-gray-500">Payments are handled in SchoolPay. This view tracks internal follow-up and admin status only.</p></div>

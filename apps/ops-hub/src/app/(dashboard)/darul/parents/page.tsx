...
export default async function DarulParentsPage() {
  const { guardians } = await getDarulAdminData()
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Darul Swafa parents</h1>
      ...
      <section className="overflow-x-auto rounded-xl border border-gray-100 bg-white shadow-sm">
        {guardians.length === 0 ? (
          <p className="p-6 text-sm text-gray-500">No parents/guardians yet.</p>
        ) : (

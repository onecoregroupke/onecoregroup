...
export default async function RhythmsSchoolpayPage() {
  const { batches, snapshots } = await getRhythmsAdminData()
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-gray-500">Import SchoolPay snapshots for Rhythms College. Payments still stay in SchoolPay.</p>
      </div>

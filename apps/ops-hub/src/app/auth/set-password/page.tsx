        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          {done ? (
            <div className="text-center space-y-3">
              ...
              <p className="text-slate-500 text-sm">Taking you to your portal…</p>
            </div>
          ) : (
            <>
              ...
              <p className="text-slate-500 text-sm mb-6">
                Welcome to the One Core Group Ops Hub. Choose a password to activate
                your portal — you&apos;ll use it every time you sign in to see and update your tasks.
              </p>

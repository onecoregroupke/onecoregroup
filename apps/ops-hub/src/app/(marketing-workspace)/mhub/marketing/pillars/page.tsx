...
export default function PillarsPage() {
  ...
  async function load() {
    ...
    try {
      const json = await apiFetch<{ pillars: MarketingPillar[] }>(
        '/api/mhub/marketing/pillars?includeInactive=true',
      )
  ...
  async function save() {
    ...
    try {
      ...
      const json = await apiFetch<{ pillar: MarketingPillar }>('/api/mhub/marketing/pillars', {
  ...
  async function archive(id: string) {
    setError('')
    try {
      await apiFetch('/api/mhub/marketing/pillars', {
        method: 'PATCH',

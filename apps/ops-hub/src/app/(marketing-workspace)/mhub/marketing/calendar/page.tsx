    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          One week at a glance — brands down the side, days across the top. Tap a post to read it
                    ...
                    {dayItems.map(({ row, brand }) => {
                      ...
                      return (
                        <button
                          ...
                          className="block w-full rounded-md border border-gray-100 bg-white px-2.5 py-2 text-left shadow-sm active:bg-gray-50"
                          style={{ borderLeft: `3px solid ${accent}` }}
                          aria-label={`Preview ${row.title || row.hook || 'Untitled'}`}
                        >

...
export default function PlatformsPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const [b, p] = await Promise.all([
        ...
        apiFetch<{ platforms: MarketingPlatform[] }>('/api/mhub/marketing/platforms?includeInactive=true'),
      ])
      setBrands(b.brands ?? [])
  ...
  async function save() {
    ...
    try {
      ...
      const json = await apiFetch<{ platform: MarketingPlatform }>('/api/mhub/marketing/platforms', {
  ...
  async function archive(id: string) {
    setError('')
    try {
      await apiFetch('/api/mhub/marketing/platforms', {
        method: 'PATCH',

...
// ── GET /api/mhub/users — list all users + their permissions ──────────────────────
...
// ── POST /api/mhub/users — invite a new user ──────────────────────────────────────
...
// ── PATCH /api/mhub/users — update a user's permissions / name / active state ─────
...
// ── DELETE /api/mhub/users?id= — permanently delete a user ────────────────────────

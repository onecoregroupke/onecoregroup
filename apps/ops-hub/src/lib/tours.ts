...
const OVERVIEW: TourDef = {
  ...
  steps: [
    ...
    { title: 'Daily Duties', body: 'Set recurring daily duties per person and track who has completed theirs today. Duties roll into the daily report.', target: '[data-tour="nav-/management/duties"]' },
    { title: 'My Tasks', body: 'Every team member sees their own assigned work and today’s duties here, and updates status from their phone.', target: '[data-tour="nav-/my-tasks"]' },
    { title: 'Tasks', body: 'All tasks across the group, filterable by brand and status.', target: '[data-tour="nav-/tasks"]' },

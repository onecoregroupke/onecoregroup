...
export type {
  ...
  OpsProjectRow,
  OpsTeamMemberRow,
  EmployeeEntityAssignmentRow,
  EmployeeResponsibilityRow,
  EmployeeCapabilityRow,
  EmployeeCapabilityAssignmentRow,
  EmployeeAuthorityRow,
  EmployeeCoverAssignmentRow,
  EmployeeResourceAssignmentRow,
  EmployeeQualificationRow,
  EmployeeActivityHistoryRow,
  KnowledgeEntryRow,
  KnowledgeVersionRow,
  OpsTaskRow,
  ...
  OcgScheduleRuleRow,
  OcgScheduleOccurrenceRow,
  OcgReminderRuleRow,
  OcgReminderDeliveryRow,
  OcgLeaveRequestRow,
  OcgPersonalTaskRow,
  OcgApprovalRow,
  OcgBlockerRow,
  ...
  OpsAttendanceEventRow,
  OpsAttendanceIdentityRow,
  InventoryItemRow,
  InventoryMovementRow,
  InventoryPriceHistoryRow,
  InventoryProductFamilyOrderRow,
  ...
  RecordVersionRow,
  OperationalRecordAccessRow,
  OperationalDocumentEventRow,
  HistoricalImportSourceRow,
  HistoricalImportPeriodRow,
  HistoricalImportMappingRow,
  HistoricalImportExceptionRow,
  HistoricalImportReconciliationRow,
  HistoricalImportSourceLinkRow,
  HistoricalImportEventRow,
  DocumentSeriesRow,
  SalesCustomerRow,
  SalesAccountApplicationRow,
  SalesInvoiceRow,
  SalesInvoiceItemRow,
  SalesPaymentRow,
  SalesPaymentAllocationRow,
  QbAccountMapRow,
  QbExpectedEntryRow,
  InventoryStoreRow,
